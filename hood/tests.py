...
class BusinessTest(TestCase):
  def setUp(self):
    self.user = User.objects.create(id=1, username='Lucy')
    self.neighborhood = NeighborHood.objects.create(id=1, name='home')
    self.busines = Business.objects.create(id=1, name='Moringa business', description='Moringa business description',image='https://cloudinary url',created_at='2021,6,26',updated_at='2021,6,26', neighborhood=self.neighborhood,user=self.user,email='lucy@gmail.com')
...
class TestProfile(TestCase):
  def setUp(self):
    self.user = User(id=1, username='Lucy', password='Moringa')
    self.user.save()
...
class PostTest(TestCase):
  def setUp(self):
    self.user = User.objects.create(id=1, username='LucyMoringa')
    self.neighborhood = NeighborHood.objects.create(id=1, name='home')
...
class NeighborhoodTest(TestCase):
  def setUp(self):
    self.user = User.objects.create(id=1, username='LucyMoringa')
    self.neighborhood = NeighborHood.objects.create(id=1, name='Moringa business', description='Moringa business description',image='https://cloudinary url',created_at='2021,6,26',updated_at='2021,6,26', neighborhood=self.neighborhood,user=self.user,email='lucy@gmail.com')
